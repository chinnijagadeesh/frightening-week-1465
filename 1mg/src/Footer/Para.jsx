...
function Para() {
    return (
        <div>
             <div class="container-fluid px-4 py-5 text-start">
            <h5 class="">Stay Healthy with Tata 1mg: Your Favourite Online Pharmacy and Healthcare Platform</h5>
            <h6 class="fw-bold py-2">We Bring Care to Health.</h6>
            ...
            <h6 class="fw-bold py-2">Tata 1mg: Your Favourite Online Pharmacy!</h6>
            ...
            <h6 class="fw-bold py-2">The Feathers in Our Cap</h6>
            <p>At Tata 1mg, our goal is to make healthcare understandable, accessible and affordable in India. We set out on our journey in 2015, and have come a long way since then. Along the way, we have been conferred with prestigious titles like
                <b> BML Munjal Award for 'Business Excellence through Learning and Development', Best Online Pharmacy in India Award</b> and <b>Top 50 venture in The Smart CEO-Startup50 India.</b>
                We have been selected as the only company from across the globe for <b>SD#3 "Health & Well Being for all" by Unreasonable group, US State Department.</b>
                In 2019 alone we received three awards including the <b>BMW Simply Unstoppable Award.</b>
            </p>
            <h6 class="fw-bold py-2">The Services We Offer</h6>
